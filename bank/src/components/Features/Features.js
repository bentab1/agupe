      ...
      <div className='features' style={{ display: 'flex' }}>
        <div className='feat' style={{ display: 'grid' , with:'45%'}}>
          ...
          <div style={{ display: 'grid' }}>
            <p className='tittle' style={{ marginBottom: '10px' }}>Open an account</p>
            <p className='text'>With just One click with your mobile phone, open an account and explore  the world around with us</p>
        ...
        <div className='feat' style={{ display: 'grid', width:'45%' }}>
          ...
          <div style={{ display: 'grid' }}>
            <p className='tittle  tittle_card' >Activate your  contactless  card today for free</p>
            <p className='text'>Make your all your transactions seamless with our  virtual and physical contactless card</p>
            <button className='button'>start now</button>
          </div>
        </div>
        <div className='feat' style={{ display: 'grid', width:'45%' }}>
          ...
          <div style={{ display: 'grid' }}>
            ...
            <p className='text'>Receive and make  contactless payment all over the world with our  physical Agupepay POS</p>
            <button className='button'>Start now</button>
          </div>
        </div>
