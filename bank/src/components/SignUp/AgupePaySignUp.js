...
import './agupePaySignUp.css';


function AgupePaySignUp() {
  ...
  return (
    <div style={{display:'grid', backgroundColor:'white'}} className='agupepaysignup_headpage'>

                <h3 style={{marginLeft:'430px',marginTop:'20px', color:"rgb(10, 10, 100)"}}>
                  AgupePay account Registeration:</h3>
