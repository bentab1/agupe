...
const AddMoneyBankMenu = () => {
  ...
  const bankOptions = [
    { value: "First Bank", label: "First Bank", APi: "/FirstBank-payment" },
    { value: "Zenith Bank", label: "Zenith Bank", Api: "/ZenithBank-payment" },
  ...
  return (
    ...
    >
      ...
      <p style={{ display: "flow-root", zIndex: "20", color: "red" }}>
        {error}
      </p>
    </div>
  );
